    ...
    <nav class="navbar navbar-inverse navbar-fixed-top"  >
      <div class="container">
        <div class="navbar-header" >
          ...
          <div class="row">
            <a class="navbar-brand" href="index.php" col-md-3><img src="logo.png" style="height:30px; width: 30px;"></a>
...
;
  " >
      <div class="container">
        <h1 style="text-align:center; margin:5% auto;">WELCOME TO THE BOOKHOUSE</h1>   
        <p style="text-align:center; margin:5% auto;">One stop to find all your favourite books and order them online!</p>     
      </div>
    </div>
    <?php } ?>
